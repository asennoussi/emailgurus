...
urlpatterns = [
    ...
    path('linked-accounts', views.LinkedaccountsView.as_view(), name='linked_accounts'),
    path('account_settings/<int:pk>', views.AccountSettings.as_view(), name='account_settings'),
    ...
    # Updated payment routes as separate class-based views
    path('payment-done/', views.PaymentDoneView.as_view(), name='payment_done'),
    path('payment-cancelled/', views.PaymentCanceledView.as_view(), name='payment_canceled'),
    ...
    # New EmailCatcherView route
    path('email-catcher/', views.EmailCatcherView.as_view(), name='email_catcher'),
]